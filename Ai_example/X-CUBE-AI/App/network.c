...
#define AI_NETWORK_MODEL_SIGNATURE     "df22782c07f7330c80690bb33bf2756c"
...
#define AI_TOOLS_DATE_TIME   "Mon Dec 28 12:57:30 2020"
...
AI_STATIC ai_array input_18_output_array;   /* Array #10 */
AI_STATIC ai_array dense_0_output_array;   /* Array #11 */
AI_STATIC ai_array nl_0_output_array;   /* Array #12 */
AI_STATIC ai_array dense_1_output_array;   /* Array #13 */
AI_STATIC ai_array nl_1_output_array;   /* Array #14 */
AI_STATIC ai_array dense_2_output_array;   /* Array #15 */
AI_STATIC ai_array nl_2_output_array;   /* Array #16 */
AI_STATIC ai_array dense_3_output_array;   /* Array #17 */
AI_STATIC ai_array nl_3_output_array;   /* Array #18 */
AI_STATIC ai_array dense_4_output_array;   /* Array #19 */
AI_STATIC ai_array nl_4_output_array;   /* Array #20 */
...
AI_STATIC ai_tensor input_18_output;   /* Tensor #10 */
AI_STATIC ai_tensor dense_0_output;   /* Tensor #11 */
AI_STATIC ai_tensor nl_0_output;   /* Tensor #12 */
AI_STATIC ai_tensor dense_1_output;   /* Tensor #13 */
AI_STATIC ai_tensor nl_1_output;   /* Tensor #14 */
AI_STATIC ai_tensor dense_2_output;   /* Tensor #15 */
AI_STATIC ai_tensor nl_2_output;   /* Tensor #16 */
AI_STATIC ai_tensor dense_3_output;   /* Tensor #17 */
AI_STATIC ai_tensor nl_3_output;   /* Tensor #18 */
AI_STATIC ai_tensor dense_4_output;   /* Tensor #19 */
AI_STATIC ai_tensor nl_4_output;   /* Tensor #20 */
...
AI_STATIC_CONST ai_tensor_chain nl_2_chain;   /* Chain #5 */
AI_STATIC_CONST ai_tensor_chain dense_3_chain;   /* Chain #6 */
AI_STATIC_CONST ai_tensor_chain nl_3_chain;   /* Chain #7 */
AI_STATIC_CONST ai_tensor_chain dense_4_chain;   /* Chain #8 */
AI_STATIC_CONST ai_tensor_chain nl_4_chain;   /* Chain #9 */
...
AI_STATIC ai_layer_nl nl_2_layer; /* Layer #5 */
AI_STATIC ai_layer_dense dense_3_layer; /* Layer #6 */
AI_STATIC ai_layer_nl nl_3_layer; /* Layer #7 */
AI_STATIC ai_layer_dense dense_4_layer; /* Layer #8 */
AI_STATIC ai_layer_nl nl_4_layer; /* Layer #9 */
...
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  input_18_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 4, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 2, 1, 1, 1), AI_STRIDE_INIT(4, 4, 8, 8, 8),
...
/* Tensor #10 */
AI_TENSOR_OBJ_DECLARE(
  input_18_output, AI_STATIC,
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 1, 1), AI_STRIDE_INIT(4, 4, 4, 16, 16),
  1, &input_18_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_18_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 96, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &input_18_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    input_18_output_array.data = AI_PTR(NULL);
    input_18_output_array.data_start = AI_PTR(NULL);
    ...
    dense_4_output_array.data = AI_PTR(activations + 8);
    dense_4_output_array.data_start = AI_PTR(activations + 8);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_4_bias_array.data = AI_PTR(weights + 1056);
    dense_4_bias_array.data_start = AI_PTR(weights + 1056);
    dense_4_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_4_weights_array.data = AI_PTR(weights + 1048);
    dense_4_weights_array.data_start = AI_PTR(weights + 1048);
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(weights + 1040);
    dense_3_bias_array.data_start = AI_PTR(weights + 1040);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 1008);
    dense_3_weights_array.data_start = AI_PTR(weights + 1008);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 992);
    dense_2_bias_array.data_start = AI_PTR(weights + 992);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 864);
    dense_2_weights_array.data_start = AI_PTR(weights + 864);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 832);
    dense_1_bias_array.data_start = AI_PTR(weights + 832);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 320);
    dense_1_weights_array.data_start = AI_PTR(weights + 320);
    dense_0_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_0_bias_array.data = AI_PTR(weights + 256);
    dense_0_bias_array.data_start = AI_PTR(weights + 256);
